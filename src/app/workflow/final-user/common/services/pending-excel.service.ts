...
@Injectable()
export class PendingExcelService {
  private workbook!: Workbook;

  public downloadExcel(dataExcel: ISearchResponsePending[]): void {
    this.workbook = new Workbook();
    this.createPendingTable(dataExcel);
  ...
  private createPendingTable(data: ISearchResponsePending[]) {
    //Crea hoja
