...
import { PracticingDashboardComponent } from './practicing-dashboard.component';
import { PracticingDashboardContainer } from './practicing-dashboard.container';
...
@NgModule({
  ...
  declarations: [PracticingDashboardComponent, PracticingDashboardContainer],
  exports: [PracticingDashboardContainer],
})
export class PracticingDashboardModule {}
