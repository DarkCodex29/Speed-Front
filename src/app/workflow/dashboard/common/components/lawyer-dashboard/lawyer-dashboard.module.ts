...
import { LawyerDashboardContainer } from './lawyer-dashboard.container';
...
@NgModule({
  ...
  declarations: [LawyerDashboardComponent, LawyerDashboardContainer],
  exports: [LawyerDashboardContainer],
})
