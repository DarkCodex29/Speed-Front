...
!(function (t, e) {
  ...
  class et extends B {
    ...
    static collapseInterface(t, e) {
      ...
      if (
        (!i && n.toggle && 'string' == typeof e && /show|hide/.test(e) && (n.toggle = !1), i || (i = new et(t, n)), 'string' == typeof e)
      ) {
  ...
  P.on(document, 'click.bs.collapse.data-api', '[data-bs-toggle="collapse"]', function (e) {
    ...
    t.find(s).forEach((t) => {
      ...
      let n;
      e
        ? (null === e._parent && 'string' == typeof i.parent && ((e._config.parent = i.parent), (e._parent = e._getParent())),
          (n = 'toggle'))
        : (n = i),
  ...
  function Mt(t) {
    ...
    return a
      ? Object.assign(
          ...
          (A[_] = m ? '0' : ''),
          (A.transform =
            (v.devicePixelRatio || 1) < 2 ? 'translate(' + u + 'px, ' + p + 'px)' : 'translate3d(' + u + 'px, ' + p + 'px, 0)'),
          A),
        )
      ...
      fn: function (t) {
        ...
        null != e.modifiersData.popperOffsets &&
          (e.styles.popper = Object.assign(
            ...
            e.styles.popper,
            Mt(
              Object.assign({}, c, { offsets: e.modifiersData.popperOffsets, position: e.options.strategy, adaptive: r, roundOffsets: l }),
            ),
          )),
          null != e.modifiersData.arrow &&
            (e.styles.arrow = Object.assign(
              {},
              e.styles.arrow,
              Mt(Object.assign({}, c, { offsets: e.modifiersData.arrow, position: 'absolute', adaptive: !1, roundOffsets: l })),
            )),
      ...
      : Kt(
          (function (t) {
            var e,
              ...
              l = -n.scrollTop;
            return (
              'rtl' === yt(s || i).direction && (a += kt(i.clientWidth, s ? s.clientWidth : 0) - o), { width: o, height: r, x: a, y: l }
            );
          })(Et(t)),
        );
  }
        ...
        for (
          var s = i.mainAxis,
            ...
            v = [g].concat(b).reduce(function (t, i) {
              return t.concat(
                'auto' === gt(i)
                  ? Zt(e, { placement: i, boundary: h, rootBoundary: d, padding: c, flipVariations: p, allowedAutoPlacements: m })
                  : i,
              );
            }, []),
            y = e.rects.reference,
        ...
        h = {
          ...
          setOptions: function (i) {
            d(),
              ...
              (a.scrollParents = { reference: ut(t) ? Vt(t) : t.contextElement ? Vt(t.contextElement) : [], popper: Vt(e) });
            var s,
              r,
              c = (function (t) {
                var e = (function (t) {
    ...
    static dataApiKeydownHandler(e) {
      if (
        /input|textarea/i.test(e.target.tagName)
          ? 'Space' === e.key ||
            ('Escape' !== e.key && (('ArrowDown' !== e.key && 'ArrowUp' !== e.key) || e.target.closest('.dropdown-menu')))
          : !pe.test(e.key)
      )
        return;
      ...
      if (null !== t)
        return r(e)
          ...
          : void (this._config.html
              ? (this._config.sanitize && (e = Re(e, this._config.allowList, this._config.sanitizeFn)), (t.innerHTML = e))
              : (t.textContent = e));
    }
    getTitle() {
  ...
  class Je extends B {
    ...
    _getConfig(t) {
      if (
        'string' != typeof (t = { ...Ge, ...U.getDataAttributes(this._element), ...('object' == typeof t && t ? t : {}) }).target &&
        r(t.target)
      ) {
        let { id: i } = t.target;
