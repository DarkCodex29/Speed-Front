...
var HdcSelect = (function () {
  ...
  e.prototype.getValueKey = function () {
    ...
    if (this.value) {
      ...
      return this.valueKey && typeof o === 'object' ? getValueByPath(o, this.valueLabel.split('.')) : o;
    } else {
...
export { HdcSelect as hdc_select };
//# sourceMappingURL=hdc-select.entry.js.map
