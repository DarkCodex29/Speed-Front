        ...
        function (t, n, e) {
          ...
          (t.exports = function (t, n, e, u) {
            var c = !!u && !!u.unsafe,
              ...
              p = !!u && !!u.noTargetGet;
            'function' == typeof e &&
              ('string' != typeof n || i(e, 'name') || o(e, 'name', n), (s(e).source = l.join('string' == typeof n ? n : ''))),
          ...
          var r = e(64),
            ...
            f = function (t) {
              ...
              return function (h, v, g, d) {
                for (
                  var y, x, m = i(h), b = o(m), S = r(v, g, 3), E = a(b.length), w = 0, O = d || u, R = n ? O(h, E) : e ? O(h, 0) : void 0;
                  E > w;
                  w++
                )
          ...
          t.exports = function (t, n, e, s, h, x, m) {
            ...
            if (
              (k &&
                ...
                v !== Object.prototype &&
                  b.next &&
                  (l || i(b) === v || (a ? a(b, v) : 'function' != typeof b[d] && c(b, d, y)), u(b, O, !0, !0), l && (p[O] = y))),
              'values' == h &&
                j &&
                'values' !== j.name &&
                ((R = !0),
          ...
          r(
            ...
            },
            {
              toFixed: function (t) {
                ...
                return (v =
                  l > 0 ? h + ((u = v.length) <= l ? '0.' + a.call('0', l - u) + v : v.slice(0, u - l) + '.' + v.slice(u - l)) : h + v);
              },
            },
          );
        },
        ...
        function (t, n, e) {
          var r,
            ...
            Q = function (t, n, e) {
              var r, o;
              X
                ? (((r = q.createEvent('Event')).promise = n), (r.reason = e), r.initEvent(t, !1, !0), f.dispatchEvent(r))
          ...
          var r = e(39),
            ...
            u = function (t) {
              return function (n, e, u) {
                ...
                return h <= l || '' == p
                  ? s
                  : ((c = h - l), (f = o.call(p, a(c / p.length))).length > c && (f = f.slice(0, c)), t ? s + f : f + s);
              };
            };
        ...
        function (t, n, e) {
          ...
          var r,
            ...
            D = function (t) {
              ...
              if ('object' == typeof t) {
                for (
                  ...
                  (o && 0 === t[e]) ||
                    (o && (o = !1), r === e ? ((n += e ? ':' : '::'), (o = !0)) : ((n += t[e].toString(16)), e < 7 && (n += ':')));
                return '[' + n + ']';
              }
              return t;
            },
            ...
            H = function (t) {
              var n;
              return (
                t.length > 1 && J(t.slice(0, 2)) && (2 == t.length || '/' === (n = t.charAt(2)) || '\\' === n || '?' === n || '#' === n)
              );
            },
            Q = function (t) {
              var n = t.path,
                    ...
                    if (a == r || '/' == a || ('\\' == a && X(t)) || (!e && ('?' == a || '#' == a))) {
                      if (
                        ('..' === (f = (f = v).toLowerCase()) || '%2e.' === f || '.%2e' === f || '%2e%2e' === f
                          ...
                          : Z(v)
                          ? '/' == a || ('\\' == a && X(t)) || t.path.push('')
                          : ('file' == t.scheme && !t.path.length && J(v) && (t.host && (t.host = ''), (v = v.charAt(0) + ':')),
                            t.path.push(v)),
                        (v = ''),
            ...
            Ot = function () {
              ...
              return (
                null !== o
                  ? ((f += '//'), Y(t) && (f += e + (r ? ':' + r : '') + '@'), (f += D(o)), null !== i && (f += ':' + i))
                  : 'file' == n && (f += '//'),
...
*/
      ...
      (s.register = function (e, n) {
        ...
        (s.resolve = function (e, n) {
          var o = (function (e, n) {
            ...
            if (
              ('.' === e[0] &&
                ('/' === e[1] || ('.' === e[1] && ('/' === e[2] || (2 === e.length && (e += '/')))) || (1 === e.length && (e += '/')))) ||
              '/' === e[0]
            ) {
    ...
    var regex = /\/hdc-wc(\.esm)?\.js($|\?|#)/;
    var scriptElm =
      currentScript ||
      Array.from(document.querySelectorAll('script')).find(function (s) {
        return regex.test(s.src) || s.getAttribute('data-stencil-namespace') === 'hdc-wc';
      });
    ...
    var start = function () {
      ...
      var url = new URL(
        './p-9f9816cd.system.js',
        new URL(resourcesUrl, window.location.origin !== 'null' ? window.location.origin : undefined),
      );
